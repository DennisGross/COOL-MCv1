python cool_mc.py --task training --max_steps 20 --prism_file_path frozen_lake_4x4.prism --project_name example11 --constant_definitions "slippery=0.04" --architecture dqn --num_episodes 101 --eval_interval 100 --prop 'Pmax=? [F "water"]' --prop_type "min_prop"
